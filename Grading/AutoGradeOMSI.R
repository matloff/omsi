...
# Here Problem 3 is worth 10 points.  The answer consists of the def and
# print lines, and the student's answer, which OMSI will have placed in the file
# omsi_answer3.py, is to be run through python
