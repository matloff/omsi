...
# The instructor places a file PtsCmds in the top directory; format for
# Question i will consist of a pair beginning with % and $,

#   % file_name_for_Quest_i  point_total-_for_Quest_i 
#   $ command line

# The second line is to compile/run, for exam problems involving program
# code.  For text problems, it will be empty other than the $.
...
#    % omsi_answer4.c 20
#    $ rm a.out; gcc -fopenmp omsi_answer4.c; ./a.out

# Here Problem 4, worth 20 points, has been placed by OMSI into a file
# omsi_answer4.c.  It will be compiled and run.  Note that we first remove
# a.out, which may be left over from the grading of the previous student.
...
# appending a line consisting of 'f(3)', then running through Rscript.
